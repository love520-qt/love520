...
(function(a, n) {
    ...
    const n = {
      ...
      , eu = t=>Array.from(t.attributes).reduce((h,d)=>(h[d.name] = d.value,
    h), {})
      , ru = t=>typeof t == "string" ? t : !t || !t.class ? "" : t.class && typeof t.class == "string" ? t.class.split(" ") : t.class && Array.isArray(t.class) ? t.class : ""
      , ou = t=>t.flatMap(ru).map(h=>h.trim()).filter(Boolean).filter((h,d,c)=>c.indexOf(h) === d).join(" ")
      , vu = t=>t.replace(/(\w)(\w*)(_|-|\s*)/g, (h,d,c)=>d.toUpperCase() + c.toLowerCase())
    ...
    var Mu = Object.freeze({
        ...
        AlignHorizontalDistributeStart: Xa,
        ...
        DatabaseBackup: F6,
        DatabaseZap: z6,
        DecimalsArrowLeft: D6,
        DecimalsArrowRight: T6,
        Delete: R6,
        Dessert: q6,
        Diameter: U6,
        Diamond: G6,
        ...
        GitPullRequestCreate: e9,
        GitPullRequestCreateArrow: n9,
        GitPullRequestDraft: l9,
        Github: o9,
        Gitlab: v9,
        GlassWater: $9,
        Glasses: m9,
    ...
    const pu = ({icons: t=Mu, nameAttr: h="data-lucide", attrs: d={}, root: c=document, inTemplates: M}={})=>{
...
lucide.createIcons({icons});\``);
        ...
        M && Array.from(c.querySelectorAll("template")).forEach(p=>pu({
            icons: t,
            nameAttr: h,
            attrs: d,
            root: p.content,
    ...
    a.AlignHorizontalDistributeStart = Xa,
    ...
    a.CircleDashed = Hd,
    a.CircleDivide = l1,
    a.CircleDollarSign = wd,
    a.CircleDot = Vd,
    a.CircleDotDashed = Ad,
    a.CircleEllipsis = Sd,
    a.CircleEqual = Ld,
    ...
    a.DatabaseBackup = F6,
    a.DatabaseZap = z6,
    a.DecimalsArrowLeft = D6,
    a.DecimalsArrowRight = T6,
    a.Delete = R6,
    a.Dessert = q6,
    a.Diameter = U6,
    a.Diamond = G6,
    ...
    a.GitPullRequestCreate = e9,
    a.GitPullRequestCreateArrow = n9,
    a.GitPullRequestDraft = l9,
    a.Github = o9,
    a.Gitlab = v9,
    a.GlassWater = $9,
    a.Glasses = m9,
    ...
    a.MessageCircleMore = cl,
    a.MessageCircleOff = dl,
